                ...
                <div class="primary-nav-section">
                    <div class="container">
                        <ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
                            ...
                            <li class="menu-item">
                                <a href="{{ route('pet_shop.shop') }}" class="link-term mercado-item-title">Shop</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('pet_shop.cart') }}" class="link-term mercado-item-title">Cart</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('pet_shop.checkout') }}" class="link-term mercado-item-title">Checkout</a>
                            </li>
                            <li class="menu-item">
