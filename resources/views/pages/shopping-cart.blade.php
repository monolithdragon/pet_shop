                    ...
                    @foreach (Cart::content() as $item)
                        ...
                        <li class="pr-cart-item">
                            ...
                            <div class="product-name">
                                <a class="link-to-product" href="{{ route('product.details', ['product' => $item->model]) }}">{{ $item->model->name }}</a>
                            </div>
                            <div class="price-field produtc-price"><p class="price">${{ $item->model->price }}</p></div>
                            <div class="quantity">
                                <div class="quantity-input">
                                    <input type="text" name="product-quatity" value="{{ $item->qty }}" data-max="120" pattern="[0-9]*" >									
                                    <button class="btn btn-increase" wire:click.prevent="incrementQuantity('{{ $item->rowId }}')"></button>
                                    <button class="btn btn-reduce" wire:click.prevent="decrementQuantity('{{ $item->rowId }}')"></button>
                                </div>
                            </div>
