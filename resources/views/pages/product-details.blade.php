                        ...
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5"
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{ route('product.details', ['product' => $related_product]) }}" title="{{ $related_product->name }}">
                                        <figure><img src="{{ asset('assets/images/products') }}/{{ $related_product->image }}"
                                    ...
                                    <div class="wrap-btn">
                                        <a href="{{ route('product.details', ['product' => $related_product]) }}" class="function-link">quick view</a>
                                    </div>
                                </div>
                                <div class="product-info">
                                    <a href="{{ route('product.details', ['product' => $related_product]) }}" class="product-name"><span>{{ $related_product->name }}</span></a>
